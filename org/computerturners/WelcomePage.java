...
public class WelcomePage extends JFrame {
    ...
    private void initComponents() throws MalformedURLException {
        ...
        ImageIcon logoIcon = new ImageIcon("src/main/assets/logo-icon.png"); // Replace "path_to_logo_image.png" with the actual path to your logo image
...
//        productPanel.removeAll();
//
//        JLabel buildGuidesLabel = new JLabel("Build Guides", SwingConstants.CENTER);
//        productPanel.add(buildGuidesLabel);
//
//        revalidate();
//        repaint();
//    }
    ...
    private void displayBuildGuides() {
        try {
            productPanel.removeAll();
            JSONParser parser = new JSONParser();
            Object obj = parser.parse(new FileReader("build_guides.json")); // Replace "build_guides.json" with the actual path to your JSON file
