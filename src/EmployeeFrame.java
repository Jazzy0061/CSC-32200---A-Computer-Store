...
public class EmployeeFrame extends JFrame {
	private static final long serialVersionUID = 2644179524420619548L;
	private String name;
    ...
    private void initComponents() throws MalformedURLException {
        ...
        appsButton = new JButton("Review applications");
	...
	private JPanel createPendingListPanel() {
    	...
    	try (BufferedReader br = new BufferedReader(new FileReader("pending_applications.csv"))) {
    	...
    	list.setCellRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                label.setText("<html><b>New application</b><br/>" + emailListModel.get(index) + "</html>");
                return label;
            }
        });
        ...
        rejectButton.setPreferredSize(new Dimension(150, 50));
        ...
        rejectButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int selectedIndex = list.getSelectedIndex();
                if (selectedIndex != -1) {
                	File inputFile = new File("pending_applications.csv");
                    ...
                    try {
                        ...
                        while ((currentLine = reader.readLine()) != null) {
                            ...
                            if (trimmedLine.contains(emailListModel.getElementAt(selectedIndex))) continue; // Skip the line
                        ...
                        boolean rensuccessful = tempFile.renameTo(inputFile);
                        if (!rensuccessful) {
                    ...
                    try {
                    	String[] appToReject = appData.get(emailListModel.getElementAt(selectedIndex));
                        BufferedWriter writer = new BufferedWriter(new FileWriter("rejected_applications.csv", true));
                        writer.write(emailListModel.getElementAt(selectedIndex) + "," + appToReject[0] + "," + appToReject[1] + "," + appToReject[2] + System.getProperty("line.separator"));
                        writer.close();
                    } catch (IOException wer) {
                        wer.printStackTrace();
                    }
